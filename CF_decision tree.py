...
if __name__ == '__main__':
    fr = open('D:\\Research\\3D-moving-pattern\\CF-dt-input.txt') # the path of the input file
    lenses =[inst.strip().split(' ') for inst in fr.readlines()]
    lensesLabels = ['residual','ratio','egm','time series']
    lensesTree =createTree(lenses,lensesLabels)
    CF_treePlotter.createPlot(lensesTree)